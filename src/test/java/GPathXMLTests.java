import config.VideoGameXMLConfig;
...
public class GPathXMLTests extends VideoGameXMLConfig {
    ...
    public void getAllNodesBasedOnACondition(){
        String responseAsString = get(VideoGamesEndpoints.ALL_VIDEO_GAMES).asString();
        int reviewScore = 90;
        List<Node> allVideoGameOverCertainScore = XmlPath.from(responseAsString).
